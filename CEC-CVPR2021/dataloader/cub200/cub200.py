...
if __name__ == '__main__':
    expDir = 'experiment_20'
    totalTrainSamples = 0
    dataroot = '/scratch/tahmad/FSCIL_datasets/CUB_200'
    #dataroot = '/net/patriot/scratch/tahmad/FSCIL_datasets/CUB_200'
    
    fileName = '/home/tahmad/work/FSOWL/' + expDir + '/class_dist_per_session.npy' 
    classes_per_sess = np.load(fileName)
    
    for k in range(len(classes_per_sess)):
    
      base_class = classes_per_sess[k]
      print(base_class)
      ...
      if k+1 < 10:
        txt_path = '/home/tahmad/work/FSOWL/' + expDir + '/session_0' + str(k+1) + '.txt'
      else:
        txt_path = '/home/tahmad/work/FSOWL/' + expDir + '/session_' + str(k+1) + '.txt'
        
      trainset = CUB200(root=dataroot, train=True, index_path=txt_path)
      cls = np.unique(trainset.targets)
      print(trainset.__len__())
      totalTrainSamples += trainset.__len__()
      
      print('###########################################')
      
    print('totalTrainSamples: ', totalTrainSamples)
