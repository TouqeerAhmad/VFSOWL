...
def getTrainSet(session_ID, expDir):
    
    session_file_names = ['session_01.txt', 'session_02.txt', 'session_03.txt', 'session_04.txt', 'session_05.txt', 'session_06.txt', 'session_07.txt',
                            'session_08.txt', 'session_09.txt', 'session_10.txt', 'session_11.txt', 'session_12.txt', 'session_13.txt', 'session_14.txt',
                            'session_15.txt', 'session_16.txt', 'session_17.txt', 'session_18.txt', 'session_19.txt', 'session_20.txt', 'session_21.txt', 
                            'session_22.txt', 'session_23.txt', 'session_24.txt', 'session_25.txt', 'session_26.txt', 'session_27.txt', 'session_28.txt', 
                            'session_29.txt', 'session_30.txt', 'session_31.txt']
    txt_path = '/home/tahmad/work/VFSOWL/experiments_cub200/' + expDir + '/' + session_file_names[session_ID-1]
    
    fileName = '/home/tahmad/work/VFSOWL/experiments_cub200/' + expDir + '/class_dist_per_session.npy' 
    num_classes_per_session = np.load(fileName)
...
def getValSet(session_ID, expDir):
...
def main(args):
    ...
    if args.split == 'train':
        print('Train Split')
        train_dataset = getTrainSet(args.session_ID, args.expDir)
    else:
        print('Val Split')
        train_dataset = getValSet(args.session_ID, args.expDir)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--expDir",
                        ...
                        help="Dir containing the .csv files for experiment.")                    
